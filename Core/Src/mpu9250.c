...
//     zeta = 0.015; // increasey bias drift gain after stabilized
 //   }
  ...
  // For more see http://en.wikipedia.org/wiki/Conversion_between_quaternions_and_Euler_angles which has additional links.
        ...
        //由于MPU9250的坐标系与机器人坐标系相差90度
        //MPU9250测量出来的俯仰角的负值为机器人的横滚角，测量出来的横滚角为机器人的俯仰角
        ROBOT_ROL = (int16_t)(-pitch);   
        ROBOT_PIT = (int16_t)(roll);
        ROBOT_YAW = (int16_t)yaw;
        // DT_Send03(roll * 1.5,-pitch * 1.5,yaw * 1.5,1);
	}
}
